...
fun autoconfTask(target: KonanTarget): Exec {
  ...
  return tasks.create("srcAutoconf${target.platformNameCapitalized}", Exec::class) {
...
fun configureTask(target: KonanTarget): Exec {
  ...
  return tasks.create("configure${target.platformNameCapitalized}", Exec::class) {
    ...
    val args = listOf(
      ...
      "--with-ca-path=/etc/ca-certificates:/etc/ssl/certs",
...
fun buildTask(target: KonanTarget): Exec {
  ...
  return tasks.create("build${target.platformNameCapitalized}", Exec::class) {
