...
fun requestOption(
  ...
  kipfsgo.KRequestOption(requestRefID, cName, cValue)
...
fun postData(
  ...
  return kipfsgo.KRequestPostBytes(requestRefID, cData, dataLength).useContents {
    r2?.copyToKString()?.also {
...
fun createRequest(
  ...
  memScoped {
    ...
    return kipfsgo.KCreateRequest(shellRefId, cCommand, cArg).useContents {
