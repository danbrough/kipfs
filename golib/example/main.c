...
#include "libjnidemo_api.h"
#include "stdio.h"

int main(int argc, char** argv) {
  //obtain reference for calling Kotlin/Native functions
  libjnidemo_ExportedSymbols* lib = libjnidemo_symbols();
  ...
  //create Kotlin object instancelibjnidemo_kref_danbroid_mpp_Clazz
  libjnidemo_kref_danbroid_mpp_Clazz newInstance = lib->kotlin.root.danbroid.mpp.Clazz.Clazz();
